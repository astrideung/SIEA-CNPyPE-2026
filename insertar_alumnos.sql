-- ========================================
-- INSERCIÓN DE 20 ALUMNOS PARA SIEA
...
-- Limpiar alumnos existentes (opcional, comentar si quieres mantenerlos)
-- DELETE FROM alumnos;
...
-- ========================================
SELECT 'ALUMNOS INSERTADOS CORRECTAMENTE' AS resultado;
SELECT especialidad_id, COUNT(*) as total_alumnos 
FROM alumnos 
WHERE activo = 1 
